...
#link_to = "https://github.com/TheMj0ln1r/novel-cryptography-project"
+++
...
![Video Encryption](/assets/files/project_files/novel-cryptography/video_encryption.jpg)

   - The server-side encryption involves AES encryption of each 1MB chunk of the video file.

![keygeneration](/assets/files/project_files/novel-cryptography/keygeneration.jpg)
